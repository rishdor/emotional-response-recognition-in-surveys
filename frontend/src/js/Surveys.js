    ...
    const fetchData = async () => {
      try {
        ...
        if (surveysResponse.ok) {
          ...
          const surveysArray = Array.isArray(surveysData.surveys)
            ? surveysData.surveys.flat()
            : Object.values(surveysData.surveys).flat();

          const notStartedSurveys = surveysArray.filter(
            (survey) => survey.survey_state === 'not_started'
          );
          ...
          setSurveys({
            ...
            inProgress: inProgressSurveys.sort(
